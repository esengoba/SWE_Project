...
/**This class implements JRadioButtons to allow toggling the timer to on/off
 *
 * */

public class TimerPanel extends MyPanel{
    ...
    public TimerPanel(){
        ...
        JLabel settingsTitle = new JLabel("Timer", SwingConstants.CENTER);
...
//        the following line to be considered if we want the on/off buttons in the centre of the page
